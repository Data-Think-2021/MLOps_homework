...
What's the first hash for the Scikit-Learn dependency?"sha256:065e9673e24e0dc5113e2dd2b4ca30c9d8aa2fa90f4c0597241c93b63130d233",

```shell
pipenv install mlflow scikit-learn prefect pandas boto3

```

## Q5. Parametrize the script

Let's now make the scripconfigurable via CLI. We'll create two 
...
Solution:
use one of the three options to parametrize the script:  
argparse, click, or sys
